...
base_model = AutoModelForSequenceClassification.from_pretrained("microsoft/DialoGPT-small", num_labels=num_classes).to(device)
...
for epoch in range(n_epochs):
    ...
    with open(f"{n_epochs}_base_result.txt", mode="a", encoding="utf8") as f:
        f.write("\t".join(result) + "\n")
